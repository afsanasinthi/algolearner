            ...
            <?php
                   if(isset($_GET['id'])){
                       ...
                       if($count==1){
                        ...
                        header('location:'.SITEURL.'admin/manageblog.php');
                     }
            ...
            <table class="tbl-30">
                       ...
                       <tr>
                           ...
                           <td>
                              <?php
                                  if($current_image!=""){
                                      ?>
                                       <img src="<?php echo SITEURL ?>images/blog/<?php echo $current_image ;?>" width="100px" height="100px" alt="<?php echo $title ?>">
                                      <?php
                    ...
                    <tr>
                       ...
                       <input type="hidden" name="current_image" value="<?php echo $current_image;?>">
                           ...
                           <input type="submit" name="submit" value="Update blog" class="btn-2nd"> </td>
                       </tr>
                    </table>
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(isset($_FILES['image']['name'])){
                        ...
                        if($image_name!=""){
                                ...
                                $image_name = "blog_Name_".rand(000,999).'.'.$ext;
                                ...
                                if($current_image!=""){
                                    $remove_path = "../images/blog/".$current_image;
                    ...
                    $res3=mysqli_query($conn,$sql3);
                        if($res3==true){
                            $_SESSION['update-food']="<div class='success'>blog update Successfully</div>";
                            header('location:'.SITEURL.'admin/manageblog.php');
                           
                           }else{
                              // fail
                              $_SESSION['update-food']="<div class='error'>blog update UnSuccessfully</div>";
                                header('location:'.SITEURL.'admin/manageblog.php');
                           }
