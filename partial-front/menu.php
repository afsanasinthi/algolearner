        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a  class="nav-link" href="<?php echo SITEURL;?>Blogs.php">Blogs</a>
                    </li>
                    
                    <li class="nav-item">
                        <a  class="nav-link" href="<?php echo SITEURL;?>Sorting_Visualizer/index.html">Algorithm Visualizer</a>
                    </li>
                    <li class="nav-item">
                        <a  class="nav-link" href="<?php echo SITEURL;?>quiz/index.php">Take a Quiz</a>
                    </li>
                    <li class="nav-item">
